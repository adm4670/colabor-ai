 ...
 * 10. Esquecimento
 * 
 * AGORA: Usa o KnowledgeGraphStore GLOBAL (getKnowledgeGraphStore)
 * em vez de criar uma instância própria.
 */
...
import { getKnowledgeGraphStore } from "./knowledge-graph";
...
export class MemoryEngineSOTA {
  ...
  /** Agora usa o singleton GLOBAL do KnowledgeGraphStore */
  knowledgeGraph = getKnowledgeGraphStore();
  ...
  constructor(tokenBudget?: number) {
    ...
    // knowledgeGraph já inicializado como getKnowledgeGraphStore()
  }
