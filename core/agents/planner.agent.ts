import { Agent } from "../agent/agent";
    ...
    export const plannerAgent = new Agent({
        ...
        generalInstructions: `
            ...
            - Use o PythonAgent (com Playwright) para navegar na internet, buscar informacoes em sites, preencher formularios, capturar telas e fazer automacao web. O PythonAgent usa Playwright em scripts Python e pode operar em modo visivel (headed) ou background (headless).
            - Use the writer agent to produce the final response to the user.
            - Para tarefas que exigem acesso a internet, consulta a sites, scraping ou automacao de paginas web, use o PythonAgent (nao existe mais BrowserAgent separado - o PythonAgent acumulou essa funcao).
