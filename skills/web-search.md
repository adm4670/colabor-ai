# Web Search Skill
    ...
    ## Descricao
    Instrucoes para realizar buscas na web de forma eficiente usando ferramentas de navegacao.
    
    ## Keywords
    web, internet, search, pesquisa, navegacao, browser, site, url, google
    ...
    Use o BrowserAgent para navegar ate um mecanismo de busca (Google, DuckDuckGo, etc.)
    
    ### 2. Extrair resultados
    Apos a busca, extraia o texto dos resultados para encontrar a informacao desejada.
